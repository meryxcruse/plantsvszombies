		...
		$( '.packages li' ).click( function() {
			...
			$( '.homePage' ).fadeOut( function() {
				...
				setTimeout( function() {
					...
					$( '.console-text' ).html( 'Connection to the Supercell server...' );
											...
											setTimeout( function() {
												...
												setTimeout( function() {
													...
													setTimeout( function() {
														...
														$( '.console-text' ).html( 'search username...' );

														$( '.ui-progressbar-value' ).css( 'width', '35%' );

														setTimeout( function() {

															$( '.console-text' ).html( 'Username found!' );

															$( '.ui-progressbar-value' ).css( 'width', '40%' );

															setTimeout( function() {

																$( '.console-text' ).html( 'Attempt // COMBAK: connexion...' );

																$( '.ui-progressbar-value' ).css( 'width', '48%' );

																setTimeout( function() {

																	$( '.console-text' ).html( 'bind!' );

																	$( '.ui-progressbar-value' ).css( 'width', '50%' );

																	setTimeout( function() {

																		$( '.console-text' ).html( 'Loading forms 20/20!' );

																		$( '.ui-progressbar-value' ).css( 'width', '60%' );

																		setTimeout( function() {

																			$( '.console-text' ).html( '256-bit protocol data encryption...' );

																			$( '.ui-progressbar-value' ).css( 'width', '70%' );

																			setTimeout( function() {

																				$( '.console-text' ).html( 'Generation of Gems...' );
